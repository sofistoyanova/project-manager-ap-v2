...
class Home extends Component {
    ...
    async deleteProject(projectId) {
        let deleteProjectResponse = await deleteMethod(`/api/projects/delete/${projectId}`)
    ...
    async fetchProjects() {
        ...
        let getProjectsResponse = await getMethod(`/api/projects/?userId=${userId}`)
        ...
        return (
            <div>
                <div>
                        ...
                        {this.state.projects.map((project) => {
                            return (
                                <div className="project">
                                    ...
                                    <Link className="projectLink" to={`/project?projectId=${project._id}`}>See tasks</Link>
                                    <div>
                    ...
                    <Link to="addProject" className="addProjectButton">+ Add Project</Link>
                </div>
            </div>
        )
    }
